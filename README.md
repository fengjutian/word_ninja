...
**WordFlow** 是一款基于 Flutter 全平台开发的 AI 英语学习工具，通过「学习成长 + 成长激励 + AI 老师」模式，让用户在游戏化体验中完成英语学习。
...
```
传统模式：背单词 → 遗忘 → 放弃
学习者模式：学习 → 获得经验 → 升级 → 解锁技能 → 获得奖励 → 持续学习
```
...
- **词汇学习** — 单词卡片、拼写挑战、听音选词、词汇挑战
- **阅读训练** — AI 生成文章、PDF/EPUB/TXT 阅读、划词翻译、AI 长难句解析
- **听力训练** — AI 分级听力课程（A1–C1）、听写训练
- **口语训练** — AI 发音评测、情景对话
- **写作训练** — AI 批改、语法纠错
