  ...
  Widget build(BuildContext context) {
    return GridView.count(
      ...
      children: [
        ...
        _StatCard(
            '单词总数', wordCount, PhosphorIconsRegular.bookOpen, Colors.green),
        _StatCard(
            '今日活跃', activeToday, PhosphorIconsRegular.trendUp, Colors.orange),
        ...
        _StatCard('同步请求', '89,012', PhosphorIconsRegular.arrowsClockwise,
            Colors.indigo),
      ],
    );
  }
...
class _UsersTab extends StatelessWidget {
  ...
  DataRow _userRow(String email, String name, int level, int exp) =>
      DataRow(cells: [
        DataCell(Text(email)),
        DataCell(Text(name)),
        DataCell(Text('$level')),
...
class _WordsTab extends StatelessWidget {
  ...
  DataRow _wordRow(String word, String meaning, int diff, int mastery) =>
      DataRow(cells: [
        DataCell(
        ...
        DataCell(Row(children: [
          SizedBox(
              width: 100,
              child:
                  LinearProgressIndicator(value: mastery / 100, minHeight: 6)),
      ...
      children: [
        ...
        Card(
          child: Column(children: [
            SwitchListTile(
                title: const Text('允许新用户注册'), value: true, onChanged: (_) {}),
            SwitchListTile(
                title: const Text('AI 服务开关'), value: true, onChanged: (_) {}),
            SwitchListTile(
                title: const Text('调试模式'), value: false, onChanged: (_) {}),
            ListTile(
                title: const Text('API 限流'),
                subtitle: const Text('当前: 100 req/min'),
            ...
            ListTile(
                ...
                trailing:
                    TextButton(onPressed: () {}, child: const Text('清除'))),
          ]),
        ),
      ],
    );
