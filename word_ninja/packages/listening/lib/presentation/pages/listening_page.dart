    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _LevelCard('N1', '高级 · 学术讲座、辩论', PhosphorIcons.regular.brain, NinjaColors.levelMaster, () => _openLevel(context, 'N1')),
          _LevelCard('N2', '中高级 · 新闻、演讲', PhosphorIcons.regular.trendUp, NinjaColors.levelAdvanced, () => _openLevel(context, 'N2')),
          _LevelCard('N3', '中级 · 日常对话、故事', PhosphorIcons.regular.equals, NinjaColors.levelIntermediate, () => _openLevel(context, 'N3')),
          _LevelCard('N4', '初级 · 简单对话', PhosphorIcons.regular.trendDown, NinjaColors.levelBeginner, () => _openLevel(context, 'N4')),
          _LevelCard('N5', '入门 · 基础听力', PhosphorIcons.regular.star, NinjaColors.info, () => _openLevel(context, 'N5')),
          const SizedBox(height: NinjaSpacing.xl),
          Semantics(header: true, child: Text('练习模式', style: NinjaTextStyles.heading2)),
          const SizedBox(height: NinjaSpacing.md),
          _ModeCard('精听', '逐句播放，理解每一句', PhosphorIcons.regular.ear, NinjaColors.secondary,
              () => _openMode(context, '精听')),
          _ModeCard('听写', '听音频填写缺失内容', PhosphorIcons.regular.notePencil, NinjaColors.accentPurple,
              () => _openMode(context, '听写')),
          _ModeCard('跟读', '边听边读，录音后AI评分', PhosphorIcons.regular.microphoneStage, NinjaColors.success,
      ...
      builder: (_) => Scaffold(
        ...
        body: Center(
          child: Column(
            ...
            children: [
              Icon(PhosphorIcons.regular.headphones, size: 64, color: NinjaColors.primary.withValues(alpha: 0.3)),
      ...
      builder: (_) => Scaffold(
        ...
        body: Center(
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(PhosphorIcons.regular.musicNote, size: 64, color: NinjaColors.primary.withValues(alpha: 0.3)),
              const SizedBox(height: NinjaSpacing.lg),
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        ...
        trailing: const Icon(PhosphorIcons.fill.playCircle, color: NinjaColors.primary),
        onTap: onTap,
      ),
    );
  }
